...
const RightCardContent = (props) => {
  return (
       <div className='absolute top-0 left-0 h-full w-full  p-6 flex flex-col justify-between'>
        ...
        <div>
            <p className='text-sm px-2 text-white'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam, facere, repellat labore voluptatibus nostrum distinctio in temporibus, amet obcaecati animi ipsa laudantium beatae ex minima dolorem quidem. Expedita, inventore doloremque?</p>
